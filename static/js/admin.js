...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadDashboardData() {
        ...
        .then(([usersData, roomsData, messagesData, filesData]) => {
            users = usersData;
            rooms = roomsData;
            // Store the messages array and total count
            messages = messagesData.messages || [];
            messageTotal = messagesData.total || 0;
            // Store the files array and total count
    ...
    function updateFilesList() {
        ...
        filteredFiles.forEach(file => {
            // Get consistent values regardless of API format
    ...
    function editUser(user) {
        ...
        // Set modal title and current user ID
    ...
    function createUser() {
        ...
        // Set modal title and reset current user ID
    ...
    // Check for missing API endpoints and show notifications
